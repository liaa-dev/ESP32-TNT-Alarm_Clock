...
static void event_handler_cb_set_settings_obj0(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_RELEASED) {
...
static void event_handler_cb_set_settings_obj1(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_RELEASED) {
...
static void event_handler_cb_set_settings_obj2(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_RELEASED) {
...
static void event_handler_cb_set_settings_obj3(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_RELEASED) {
        ...
        }
        {
            ...
            lv_obj_set_style_flex_flow(obj, LV_FLEX_FLOW_COLUMN, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_add_event_cb(obj, event_handler_cb_set_settings_obj0, LV_EVENT_ALL, 0);
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 165, 135);
                    lv_obj_set_size(obj, 150, 50);
                    lv_obj_add_event_cb(obj, event_handler_cb_set_settings_obj1, LV_EVENT_ALL, 0);
                    lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 165, 135);
                    lv_obj_set_size(obj, 150, 50);
                    lv_obj_add_event_cb(obj, event_handler_cb_set_settings_obj2, LV_EVENT_ALL, 0);
                    lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 165, 135);
                    lv_obj_set_size(obj, 150, 50);
                    lv_obj_add_event_cb(obj, event_handler_cb_set_settings_obj3, LV_EVENT_ALL, 0);
                    lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
                ...
                }
                {
                    ...
                    lv_obj_set_style_layout(obj, LV_LAYOUT_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_textarea_set_text(obj, "12:20");
